...
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{id:"minecraft:copper_ore"}}] add tw.vm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{id:"minecraft:raw_copper"}}] add tw.vm.ore
