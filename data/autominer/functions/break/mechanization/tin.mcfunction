...
execute if score limit tw.vm.tool matches ..59 at @e[type=item,limit=1,sort=nearest,distance=..8,tag=tw.vm.ore] run function autominer:loop_level/mechanization/wooden
execute if score limit tw.vm.tool matches 131 at @e[type=item,limit=1,sort=nearest,distance=..8,tag=tw.vm.ore] run function autominer:loop_level/mechanization/stone
