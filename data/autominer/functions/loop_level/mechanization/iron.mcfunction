...
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~1 ~ if block ~ ~ ~ #autominer:ores_iron run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~-1 ~ if block ~ ~ ~ #autominer:ores_iron run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~1 ~ ~ if block ~ ~ ~ #autominer:ores_iron run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~-1 ~ ~ if block ~ ~ ~ #autominer:ores_iron run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~ ~1 if block ~ ~ ~ #autominer:ores_iron run function autominer:loop_level/mechanization/iron
...
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~1 ~ if block ~ ~ ~ #autominer:ores_mechanization[waterlogged=true,type=double] run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~-1 ~ if block ~ ~ ~ #autominer:ores_mechanization[waterlogged=true,type=double] run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~1 ~ ~ if block ~ ~ ~ #autominer:ores_mechanization[waterlogged=true,type=double] run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~-1 ~ ~ if block ~ ~ ~ #autominer:ores_mechanization[waterlogged=true,type=double] run function autominer:loop_level/mechanization/iron
execute if score damaged tw.vm.tool < limit tw.vm.tool positioned ~ ~ ~1 if block ~ ~ ~ #autominer:ores_mechanization[waterlogged=true,type=double] run function autominer:loop_level/mechanization/iron
